...
- **Second bare-metal + NVIDIA GPU install validated (2026-03-20)** — full clean-install + GPU flow confirmed working end-to-end; both docker bug fixes and GPU pre-check dialogs behave correctly.

## In Progress

- **`env-settings` placeholder corruption fix** — next coding task; see Known Issues for details
...
| koa | Windows + Ubuntu dual-boot | Development machine | setup-linux.sh validated (bare-metal + GPU, 2026-03-20) |
